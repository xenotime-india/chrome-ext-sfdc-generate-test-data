...
gulp.task("insideExtension-clean", function() {
  return gulp.src("insideExtension/build/*", { read: false }).pipe(clean());
});

//copy static folders to build directory
gulp.task("insideExtension-copy", function() {
  gulp
    .src("insideExtension/src/fonts/**")
    .pipe(gulp.dest("insideExtension/build/fonts"));
  gulp
    .src("insideExtension/src/images/**")
    .pipe(gulp.dest("insideExtension/build/images"));
  gulp
    .src("insideExtension/src/_locales/**")
    .pipe(gulp.dest("insideExtension/build/_locales"));
  return gulp
    .src("insideExtension/src/manifest.json")
...
gulp.task("insideExtension-jshint", function() {
  return gulp
    .src("insideExtension/src/scripts/*.js")
    .pipe(jshint())
...
gulp.task("insideExtension-scripts", ["insideExtension-jshint"], function() {
  gulp
    .src("insideExtension/src/scripts/vendors/**/*.js")
    .pipe(gulp.dest("insideExtension/build/scripts/vendors"));
  return (
    gulp
      .src([
        "insideExtension/src/scripts/**/*.js",
        "!insideExtension/src/scripts/vendors/**/*.js"
      ])
...
gulp.task("insideExtension-styles", function() {
  ...
  return gulp
    .src("insideExtension/src/styles/**")
...
gulp.task(
  "zip",
  [
    "insideExtension-html",
    "insideExtension-scripts",
    "insideExtension-styles",
    "insideExtension-copy"
  ],
  function() {
    ...
    gulp
      .src("insideExtension/build/scripts/**/*.map")
      .pipe(zip(mapFileName))
      .pipe(gulp.dest("insideExtension/dist"));
    //build distributable extension
    return gulp
      .src([
        "insideExtension/build/**",
        "!insideExtension/build/scripts/**/*.map"
      ])
...
gulp.task("default", ["insideExtension"], function() {});
