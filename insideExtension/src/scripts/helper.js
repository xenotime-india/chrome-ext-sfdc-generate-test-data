...
var getFieldCode = function(e, t) {
  ...
  var i = e.value;
  if ((isBlank(i) && (i = " "), (i = i.toString().rtrim()), isBlank(i)))
    return "null";
  if ("RecordType" == r) {
    if (((i = i.replace(/\[(.*)\]/g, "").rtrim()), 0 == t.recordTypes.length))
      return null;
  ...
  return "Currency" == r || "Number" == r || "Percent" == r
    ? ((i = i.replace(/\,/g, "").replace(/\%/g, "")), getNumber(i))
    : "Checkbox" == r
      ? 1 == i || "true" == i || 1 == i || "1" == i
        ? "true"
        : "false"
      : "Date" == r
        ? "Date.valueOf('" + i.replace(/\//g, "-") + "')"
        : "Date/Time" == r
          ? "Datetime.valueOf('" + i.replace(/\//g, "-") + ":00')"
          : "Master-Detail" == r || "Lookup" == r
            ? "'" + e.reference + "'"
            : "'" + punescape(i) + "'";
};
...
function showAlert(mess) {
  if (sfdcPage.dialogs["SFDCDialog"] == null) {
    ...
    sfdcPage.dialogs["SFDCDialog"].title =
      "Salesforce Deployment Helper - Xenotime"; // setting title of popup
  ...
  var message =
    '<table border="0"><tbody><tr><td style="vertical-align: top"><img src="/s.gif" class="confirmLarge" alt="Confirm"></td><td style="padding-left: 8px; vertical-align: top; line-height: 16px"><p>' +
    mess +
    "</p></td></tr></tbody></table>";
  sfdcPage.dialogs["SFDCDialog"].setContentInnerHTML(
    "<div>" + message + "</div>"
  );
